      ...
      <div className="space-y-4">
        ...
        <div className="p-4 rounded-xl bg-slate-800/60 border border-slate-700/60 text-xs space-y-2">
          <div className="flex justify-between">
            ...
            <span className="font-bold text-white">{request.leaveType?.name}</span>
          </div>
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-slate-300">{new Date(request.appliedAt).toLocaleDateString()}</span>
          </div>
          <div className="pt-2 border-t border-slate-700">
            <span className="text-slate-400 block mb-1">Applicant's Stated Reason:</span>
            <p className="italic text-slate-200 bg-slate-900/60 p-2.5 rounded-lg border border-slate-800">
              "{request.reason}"
            </p>
          </div>
        </div>
